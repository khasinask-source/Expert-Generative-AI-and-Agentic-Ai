...
dataset = pd.read_csv(r"C:\Users\DELL\Downloads\final1.csv")
...
dataset1 = pd.read_csv(r"C:\Users\Admin\Desktop\MyFile\0. DATASCIENCE PROJECT\15. Logistic regression with future prediction\Future prediction1.csv")
...
#--------
'''
dataset2 = pd.read_csv(r"C:\Users\kdata\Desktop\KODI WORK\1. NARESH\1. MORNING BATCH\N_Batch -- 10.00AM\3. May\26th,27th\Future prediction1.csv")
