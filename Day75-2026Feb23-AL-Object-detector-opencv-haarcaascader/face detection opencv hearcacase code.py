...
face_classifier = cv2.CascadeClassifier(r"C:\Users\AVITA\AVSCODE\7. OPENCV\haar cascade classifier basic project\Haarcascades\haarcascade_frontalface_default.xml\haarcascade_frontalface_default.xml")# Load the image
